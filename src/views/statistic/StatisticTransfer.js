...
const StatisticTransfer = () => {
    ...
    const handleReloadYear = (e) => {
        ...
        Promise.all([postData('http://127.0.0.1:8000/api/admin/statistic/transferByYear?token=' + getToken(), data)])
            .then(function (res) {
    ...
    const handleReloadMonth = (e) => {
        ...
        Promise.all([postData('http://127.0.0.1:8000/api/admin/statistic/transferByMonth?token=' + getToken(), data)])
            .then(function (res) {
                setDataTable(res[0].data.data)
            })
    }
    const handleReloadDay = (e) => {
        ...
        setDate(e)
        setDay(e.getDate())
        Promise.all([postData('http://127.0.0.1:8000/api/admin/statistic/transferByDay?token=' + getToken(), data)])
            .then(function (res) {
                setDataTable(res[0].data.data)
            })
    }
    ...
    useEffect(() => {
        Promise.all([
            postData('http://127.0.0.1:8000/api/admin/statistic/transferByYear?token=' + getToken(), data),
