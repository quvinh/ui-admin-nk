...
const StatisticImport = () => {
    ...
    const handleReload = () => {
        ...
        Promise.all([postData('/api/admin/statistic/importByDay?token=' + getToken(), data)])
            .then(function (res) {
    ...
    useEffect(() => {
        Promise.all([
            postData('/api/admin/statistic/importByYear?token=' + getToken(), data),
...
export default StatisticImport